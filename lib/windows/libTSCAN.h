...
typedef struct _TLIBFlexray_controller_config {
	...
	u8 config_byte;  						// bit0: 1:FlexRayChannel A set termination resistor  0:FlexRayChannel A not set termination resistor
                                            // bit1: 1:FlexRayChannel B set termination resistor  0:FlexRayChannel B not set termination resistor
