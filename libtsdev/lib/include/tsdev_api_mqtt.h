 ...
 */
#ifndef __TSDEV_API_MQTT_H
#define __TSDEV_API_MQTT_H
...
/*******************************************************LOGGER_V1*********************************************************/
    ...
    TSDEV_API tsdev_api_mqtt_config_cmd_req(tsdev_handle_t handle, const struct tsdev_mqtt_client_config_t* config);
