 ...
 */
#ifndef __TSDEV_API_ECAT_CONFIG_H__
#define __TSDEV_API_ECAT_CONFIG_H__
...
{
#endif		
	TSDEV_API tsdev_api_ecat_can_filter_config_cmd(tsdev_handle_t handle, const tsdev_ecat_can_filter_config_t* cmd_p);

	TSDEV_API tsdev_api_ecat_cmd_reg_event(tsdev_handle_t handle, 
		void* usr_arg, 
		tsdev_ecat_config_cmd_event_t event);
	TSDEV_API tsdev_api_ecat_cmd_unreg_event(tsdev_handle_t handle,
		void* usr_arg,
		tsdev_ecat_config_cmd_event_t event);
...
#endif	// __TSDEV_API_ECAT_CONFIG_H__