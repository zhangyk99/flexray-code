 ...
 */
#ifndef __TSDEV_API_LOGGER_V1_H
#define __TSDEV_API_LOGGER_V1_H
...
/*******************************************************LOGGER_V1*********************************************************/
    ...
    TSDEV_API tsdev_api_logger_v1_cmd_req(tsdev_handle_t handle, const struct tsdev_logger_cmd_req_t* config);

    TSDEV_API tsdev_api_logger_v1_cmd_reg_event(tsdev_handle_t handle, void* usr_arg,tsdev_logger_v1_event_t event);

    TSDEV_API tsdev_api_logger_v1_cmd_unreg_event(tsdev_handle_t handle, void* usr_arg,tsdev_logger_v1_event_t event);
