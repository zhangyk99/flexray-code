 ...
 */
#ifndef __TSDEV_API_PSI5_H
#define __TSDEV_API_PSI5_H
...
{
#endif
    TSDEV_API tsdev_api_psi5_cmd_req(tsdev_handle_t handle,
                                     const struct tsdev_psi5if_ecu_ch_cmd_req_t *conf);

    TSDEV_API tsdev_api_psi5_cmd_reg_event(tsdev_handle_t handle,
                                           uint32_t max_rx_cnt,
                                           void *usr_arg,
                                           tsdev_psi5_cmd_event_t event);

    TSDEV_API tsdev_api_psi5_frame_reg_event(tsdev_handle_t handle,
                                             uint32_t max_rx_cnt,
                                             void *usr_arg,
                                             tsdev_psi5_frame_event_t event);
