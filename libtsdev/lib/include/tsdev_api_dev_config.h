 ...
 */
#ifndef __TSDEV_API_DEV_CONFIG_H
#define __TSDEV_API_DEV_CONFIG_H
...
extern "C"
{
    ...
    TSDEV_API tsdev_api_dev_config_cmd(tsdev_handle_t handle, const struct tsdev_dev_config_cmd_t* cmd_p);

    TSDEV_API tsdev_api_dev_config_write_async(tsdev_handle_t handle, const struct tsdev_dev_config_data_t* data_p);

    TSDEV_API tsdev_api_dev_config_cmd_reg_event(tsdev_handle_t handle,
        void* usr_arg,
        tsdev_dev_config_cmd_event_t event);

    TSDEV_API tsdev_api_dev_config_cmd_unreg_event(tsdev_handle_t handle,
        void* usr_arg,
        tsdev_dev_config_cmd_event_t event);

    TSDEV_API tsdev_api_dev_config_cmd_unreg_events(tsdev_handle_t handle);

    TSDEV_API tsdev_api_dev_config_data_reg_event(tsdev_handle_t handle,
        void* usr_arg,
        tsdev_dev_config_data_event_t event);

    TSDEV_API tsdev_api_dev_config_data_unreg_event(tsdev_handle_t handle,
        void* usr_arg,
        tsdev_dev_config_data_event_t event);

    TSDEV_API tsdev_api_dev_config_data_unreg_events(tsdev_handle_t handle);
